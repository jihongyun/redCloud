...
package io.redCloud.utils;

import io.redCloud.entity.ColumnEntity;
import io.redCloud.entity.TableEntity;
...
public class GenUtils {
	...
	public static List<String> getTemplates(){
		...
		templates.add("template/page.html.vm");
		templates.add("template/page.js.vm");
	...
	public static void generatorCode(Map<String, String> table,
		...
		mainPath = StringUtils.isBlank(mainPath) ? "io.redCloud" : mainPath;
	...
	public static String getFileName(String template, String className, String packageName, String moduleName) {
		...
		if (template.contains("Test.java.vm")) {
			return testPackagePath + "controller" + File.separator + "Test" + className + "Controller.java";
		}
